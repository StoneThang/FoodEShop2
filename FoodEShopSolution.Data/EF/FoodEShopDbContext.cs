...
using FoodEShopSolution.Data.Configurations;
using FoodEShopSolution.Data.Entities;
using FoodEShopSolution.Data.Extensions;
...
{
    public class FoodEShopDbContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public FoodEShopDbContext(DbContextOptions options) : base(options)
        {
